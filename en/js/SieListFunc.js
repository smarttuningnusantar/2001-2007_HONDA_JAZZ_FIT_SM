...
function SetDisplayFlag(strKeywords)
{
  ...
  // Defensive check for undefined/null strKeywords
  if (typeof(strKeywords) === 'undefined' || strKeywords === null) {
    console.warn("[SetDisplayFlag] strKeywords is undefined/null, using empty string");
    strKeywords = "";
  }

  strReplace = "";
  strKeywords = strKeywords.toString().toLowerCase();
